 ...
 */
export declare namespace AppendRecord {
    /**
     ...
     */
    function fence(fencingToken: string, timestamp?: number | Date): StringAppendRecord;
    /**
     * Create a trim command record.
     */
    function trim(seqNum: number, timestamp?: number | Date): BytesAppendRecord;
}
/**
...
export interface ReadRecord<Format extends "string" | "bytes" = "string"> {
    ...
    readonly headers: Format extends "string" ? ReadonlyArray<readonly [string, string]> : ReadonlyArray<readonly [Uint8Array, Uint8Array]>;
    /** Timestamp of the record. */
    readonly timestamp: Date;
}
/** Maximum number of records in a single append batch. */
export declare const MAX_APPEND_RECORDS = 1000;
/** Maximum total metered bytes for records in a single append batch (1 MiB). */
export declare const MAX_APPEND_BYTES: number;
/**
