...
export class FetchReadSession extends ReadableStream {
    static async create(client, name, args, options) {
        ...
        if (response.error) {
            ...
            const error = "message" in response.error
                ? new S2Error({
