...
class ConsoleInterceptor {
    ...
    maxAttributeCount;
    constructor(logger, sendToStdIO, interceptingDisabled, maxAttributeCount) {
        this.logger = logger;
        ...
        if (parsed.ok) {
            this.logger.emit({
                ...
                attributes: {
                    ...
                    ...(0, flattenAttributes_js_1.flattenAttributes)(parsed.value, undefined, this.maxAttributeCount),
                },
                timestamp,
            });
            return;
