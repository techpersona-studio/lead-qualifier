...
export type OnStartAttemptHookFunction<TPayload> = (params: TaskStartAttemptHookParams<TPayload>) => undefined | void | Promise<undefined | void>;
...
export interface LifecycleHooksManager {
    ...
    registerGlobalStartAttemptHook(hook: RegisterHookFunctionParams<AnyOnStartAttemptHookFunction>): void;
    registerTaskStartAttemptHook(taskId: string, hook: RegisterHookFunctionParams<AnyOnStartAttemptHookFunction>): void;
