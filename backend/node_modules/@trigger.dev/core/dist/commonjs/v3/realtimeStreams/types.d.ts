...
export type RealtimeDefinedStream<TPart> = {
    id: string;
    pipe: (value: AsyncIterable<TPart> | ReadableStream<TPart>, options?: PipeStreamOptions) => PipeStreamResult<TPart>;
...
export type WriterStreamOptions<TPart> = Prettify<PipeStreamOptions & {
    execute: (options: {
...
export type InferInputStreamType<T> = T extends RealtimeDefinedInputStream<infer TData> ? TData : unknown;
/**
