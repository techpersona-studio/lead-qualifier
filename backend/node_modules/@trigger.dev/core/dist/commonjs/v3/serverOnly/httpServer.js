...
const http_js_1 = require("../apps/http.js");
const prom_client_1 = require("prom-client");
const utils_js_1 = require("../../utils.js");
const logger = new structuredLogger_js_1.SimpleStructuredLogger("http-server");
const HttpMethod = zod_1.z.enum([
    "GET",
    "POST",
    "PUT",
    "DELETE",
    ...
    constructor(options) {
        ...
        if (this.metricsRegister && collectMetrics) {
            if (!HttpServer.httpRequestDuration) {
                HttpServer.httpRequestDuration = new prom_client_1.Histogram({
            ...
            if (!HttpServer.httpRequestTotal) {
                HttpServer.httpRequestTotal = new prom_client_1.Counter({
        ...
        this.server = (0, node_http_1.createServer)(async (req, res) => {
            ...
            try {
                ...
                const body = await (0, http_js_1.getJsonBody)(req);
                ...
                const [error] = await (0, utils_js_1.tryCatch)(handler({
                    reply,
                    req,
                    res,
