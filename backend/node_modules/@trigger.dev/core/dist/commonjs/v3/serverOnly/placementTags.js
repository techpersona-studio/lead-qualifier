...
exports.PlacementTagProcessor = void 0;
exports.placementTag = placementTag;
const structuredLogger_js_1 = require("../utils/structuredLogger.js");
class PlacementTagProcessor {
    config;
    logger = new structuredLogger_js_1.SimpleStructuredLogger("placement-tag-processor");
    constructor(config) {
        this.config = config;
    }
    /**
...
exports.PlacementTagProcessor = PlacementTagProcessor;
/**
 ...
 */
function placementTag(key, value) {
