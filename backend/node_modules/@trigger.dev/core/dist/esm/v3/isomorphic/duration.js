 ...
 */
export function parseNaturalLanguageDurationInMs(duration) {
...
export function safeParseNaturalLanguageDuration(duration) {
    try {
...
// ... existing code ...
export function parseNaturalLanguageDurationAgo(duration) {
...
export function safeParseNaturalLanguageDurationAgo(duration) {
    try {
...
export function stringifyDuration(seconds) {
    if (seconds <= 0) {
        return;
    }
    const units = {
