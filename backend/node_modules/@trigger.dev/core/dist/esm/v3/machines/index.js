 ...
 */
export function maxOldSpaceSizeForMachine(machine, overhead = 0.2) {
 ...
 */
export function maxOldSpaceSizeFlag(machine, overhead = 0.2) {
 ...
 */
export function nodeOptionsWithMaxOldSpaceSize(existingOptions, machine, overhead = 0.2) {
