...
export async function testDockerCheckpoint() {
    const { $ } = await import("execa");
    try {
        // Create a dummy container
        const container = await $ `docker run -d --rm --name init-dummy-${randomUUID()} docker.io/library/busybox sleep 10`;
        // Checkpoint it
...
//# sourceMappingURL=checkpointTest.js.map