export function isSchemaZodEsque(schema) {
...
export function isSchemaValibotEsque(schema) {
    return typeof schema === "object" && "_types" in schema;
}
export function isSchemaArkTypeEsque(schema) {
    return typeof schema === "object" && "_inferIn" in schema && "_infer" in schema;
}
export function getSchemaParseFn(procedureParser) {
