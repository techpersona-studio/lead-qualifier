...
export function flattenAttributes(obj, prefix, maxAttributeCount, maxDepth = DEFAULT_MAX_DEPTH) {
...
export function unflattenAttributes(obj, filteredKeys, maxDepth = DEFAULT_MAX_DEPTH) {
