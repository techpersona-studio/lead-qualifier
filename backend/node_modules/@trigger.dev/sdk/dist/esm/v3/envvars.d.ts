import type { ApiPromise, ApiRequestOptions, CreateEnvironmentVariableParams, EnvironmentVariableResponseBody, EnvironmentVariableWithSecret, ImportEnvironmentVariablesParams, UpdateEnvironmentVariableParams } from "@trigger.dev/core/v3";
...
export declare function list(projectRef: string, slug: string, requestOptions?: ApiRequestOptions): ApiPromise<EnvironmentVariableWithSecret[]>;
export declare function list(requestOptions?: ApiRequestOptions): ApiPromise<EnvironmentVariableWithSecret[]>;
...
export declare function retrieve(projectRef: string, slug: string, name: string, requestOptions?: ApiRequestOptions): ApiPromise<EnvironmentVariableWithSecret>;
export declare function retrieve(name: string, requestOptions?: ApiRequestOptions): ApiPromise<EnvironmentVariableWithSecret>;
