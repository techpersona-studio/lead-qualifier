import { accessoryAttributes, apiClientManager, SemanticInternalAttributes, } from "@trigger.dev/core/v3";
 ...
 */
export async function resolvePrompt(slug, variables, options) {
...
export function listPrompts(requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
...
export function listPromptVersions(slug, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
...
export async function promotePromptVersion(slug, version, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
...
export async function createPromptOverride(slug, body, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
...
export async function updatePromptOverride(slug, body, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
...
export async function removePromptOverride(slug, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
...
export async function reactivatePromptOverride(slug, version, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
